...
$meta_description  = 'Live Sports';
$meta_keyword  = 'Live Sports';
$affliasi    = '';
$id_histats    = ' ';
$url_web  = ' '; // 
$url_dmca  = ' '; // 
 ...
 // OFFER SPORTS 
$offer_baseball  = 'LINKOFFER';
$offer_boxing  = 'LINKOFFER';
$offer_bundesliga  = 'LINKOFFER';
$offer_champions_league  = 'LINKOFFER';
$offer_copa_america  = 'LINKOFFER';
$offer_eredivisie  = 'LINKOFFER';
$offer_euro  = 'LINKOFFER';
$offer_europa_league  = 'LINKOFFER';
$offer_football  = 'LINKOFFER';
$offer_formula  = 'LINKOFFER';
$offer_international  = 'LINKOFFER';
$offer_la_liga  = 'LINKOFFER';
$offer_ligue  = 'LINKOFFER';
$offer_mlb  = 'LINKOFFER';
$offer_mls  = 'LINKOFFER';
$offer_moto_gp  = 'LINKOFFER';
$offer_nba  = 'LINKOFFER';
$offer_ncaam  = 'LINKOFFER';
$offer_ncaaf  = 'LINKOFFER';
$offer_nfl  = 'LINKOFFER';
$offer_nhl  = 'LINKOFFER';
$offer_premier_league  = 'LINKOFFER';
$offer_serie_a  = 'LINKOFFER';
$offer_soccer  = 'LINKOFFER';
$offer_softball  = 'LINKOFFER';
$offer_tennis  = 'LINKOFFER';
$offer_ufc  = 'LINKOFFER';
$offer_volleyball  = 'LINKOFFER';
