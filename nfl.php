            ...
            <br>
				<div id="video">
					<div id="video-player" class="embed-responsive embed-responsive-16by9 video pointer nocontext">
						<video id="videoPlayer" class="embed-responsive-item" preload="none" poster="https://wallpaperaccess.com/full/301291.jpg">
...
<ul class="dropdown-menu dropdown-menu-right">
	...
	<li class="hq">HD 720p</li>
			...
			<div class="text-center">
						<p class="lead" itemprop="description">Watch Online <?php echo '' . htmlspecialchars($_GET["live"]) . ''; ?> When the local mafia shows up to burn down her restaurant, Ana, a chef with a meticulous past, defends her turf and proves her knife skills both in and out of the kitchen.</p>
					</div>
			</div>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				<img class="img-responsive" src="https://wallpaperaccess.com/full/301291.jpg" width="780" height="439" alt="Aquaman">
