      ...
      <h1 style="text-align:center;color: #dcdcdc;margin-top:0px;"><?php echo '' . htmlspecialchars($_GET["live"]) . ''; ?></h1>
				...
				<div id="video">
					<div id="video-player" class="embed-responsive embed-responsive-16by9 video pointer nocontext">
						<video id="videoPlayer" class="embed-responsive-item" preload="none" poster="https://www.teahub.io/photos/full/235-2356600_volleyball-mikasa-blurred-top-10-volleyball-ball.jpg">
...
<ul class="dropdown-menu dropdown-menu-right">
	...
	<li class="hq">HD 720p</li>
			...
			<div class="text-center">
						<p class="lead" itemprop="description">Watch Online <?php echo '' . htmlspecialchars($_GET["live"]) . ''; ?> After being resurrected by a sinister entity, Art the Clown returns to Miles County where he must hunt down and destroy a teenage girl and her younger brother on Halloween night.  As the body count rises, the siblings fight to stay alive while uncovering the true nature of Art's evil intent.</p>
					</div>
			</div>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				<img class="img-responsive" src="https://www.teahub.io/photos/full/235-2356600_volleyball-mikasa-blurred-top-10-volleyball-ball.jpg" width="780" height="439" alt="Aquaman">
