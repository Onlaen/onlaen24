      ...
      <h1 style="text-align:center;color: #dcdcdc;margin-top:0px;"><?php echo '' . htmlspecialchars($_GET["live"]) . ''; ?></h1>
			...
			<div id="video">
					<div id="video-player" class="embed-responsive embed-responsive-16by9 video pointer nocontext">
						<video id="videoPlayer" class="embed-responsive-item" preload="none" poster="https://static-01.daraz.com.bd/p/dfe4e77005e7aa047bd95cc5f85189c9.jpg">
...
<ul class="dropdown-menu dropdown-menu-right">
	...
	<li class="hq">HD 720p</li>
			...
			<div class="text-center">
						<p class="lead" itemprop="description">Watch Online <?php echo '' . htmlspecialchars($_GET["live"]) . ''; ?>  HD Quality Fast Without Buffering Support Mobile Android, iPhone, iPad, Tablet.</p>
					</div>
			</div>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				<img class="img-responsive" src="https://static-01.daraz.com.bd/p/dfe4e77005e7aa047bd95cc5f85189c9.jpg" width="780" height="439" alt="Aquaman">
