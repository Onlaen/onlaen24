      ...
      <h1 style="text-align:center;color: #dcdcdc;margin-top:0px;"><?php echo '' . htmlspecialchars($_GET["live"]) . ''; ?></h1>
			...
			<div id="video">
					<div id="video-player" class="embed-responsive embed-responsive-16by9 video pointer nocontext">
						<video id="videoPlayer" class="embed-responsive-item" preload="none" poster="https://wallpaperaccess.com/full/1417874.jpg">
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				<img class="img-responsive" src="https://wallpaperaccess.com/full/1417874.jpg" width="780" height="439" alt="Aquaman">
